...
impl Statement {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn column_mapping(&self) -> Arc<HashMap<String, usize>> {
...
impl<'l, 'm> From<&'m mut Statement> for Cursor<'m> {
    #[inline]
...
impl<'l> IntoIterator for Statement {
    ...
    T: AsRef<str>,
{
    ...
    Ok(Statement {
        ...
        column_mapping: Arc::new(column_mapping),
    })
}
